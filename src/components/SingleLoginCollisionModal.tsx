      ...
      <div className="bg-surface w-full max-w-md rounded-xl shadow-2xl overflow-hidden border border-border-faint flex flex-col">
        <div className="bg-rose-500/10 p-6 flex flex-col items-center justify-center border-b border-border-faint relative">
          ...
          <p className="text-sm text-content-muted text-center mt-2 max-w-[280px]">
            {t("collision.thisAccountIsBeingUsed")}
          </p>
        </div>
        ...
        <div className="p-6">
          <div className="bg-surface-sunken border border-border-subtle rounded-xl p-4 mb-6">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-xs font-normal text-content-secondary uppercase tracking-normal">
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                ...
                <div className="min-w-0 flex-1">
                  <div className="text-xs sm:text-[10px] text-content-subtle font-normal uppercase">
