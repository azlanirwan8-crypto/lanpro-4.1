...
export function RateLimitIndicator() {
  ...
  const maxLimit = limitUrls.reduce(
    (max, url) => {
  ...
  return (
    <AnimatePresence>
      ...
      >
        <div className="bg-amber-600 text-content-inverse shadow-2xl rounded-xl p-4 flex items-center gap-3.5 border border-amber-500/30 backdrop-blur-md bg-opacity-95 font-sans">
          <div className="p-2 bg-surface/10 rounded-xl animate-pulse">
            <ShieldAlert className="w-5 h-5 text-amber-100" />
          </div>
          <div className="flex-1 min-w-0">
            <h4 className="text-xs font-normal uppercase tracking-normal text-amber-50">
          ...
          <div className="flex items-center gap-2">
            <span className="text-xs sm:text-[11px] sm:text-[9px] font-normal uppercase tracking-normal bg-surface/15 px-2 py-1 rounded-lg whitespace-nowrap">
