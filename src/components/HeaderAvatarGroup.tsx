...
export const HeaderAvatarGroup: React.FC<HeaderAvatarGroupProps> = ({
  allUsers,
  currentUserUid,
}) => {
      ...
      const timer = setTimeout(() => {
        ...
        try {
          safeLocalStorage.setItem(
            "lanpro_cached_header_online_users",
  ...
  return (
    <div className="hidden sm:flex -space-x-2 overflow-hidden py-1 px-1">
