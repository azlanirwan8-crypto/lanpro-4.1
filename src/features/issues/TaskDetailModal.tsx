            ...
            <div className="lg:col-span-8 p-3.5 sm:p-5 md:p-6 lg:p-7 space-y-4 sm:space-y-6 border-r border-border-subtle/80 bg-surface">
                ...
                return (
                  <div className="p-3.5 bg-amber-500/10 border border-amber-500/30 rounded-lg flex items-start gap-2.5 shadow-2xs">
                    ...
                    <div className="text-xs text-amber-900 space-y-0.5">
                      <p className="font-normal uppercase tracking-normal text-amber-800 text-xs sm:text-[11px]">
              ...
              <div className="bg-surface border border-border-subtle/80 rounded-lg p-4 md:p-5 shadow-2xs space-y-3">
                <div className="flex items-center justify-between">
                  <h3 className="text-xs font-normal text-content-body uppercase tracking-normalr flex items-center gap-2">
              ...
              {task.figmaUrl?.includes("figma.com") && (
                <div className="space-y-4 pt-4">
                  <div className="flex items-center justify-between">
                    <h3 className="text-sm font-normal text-content uppercase tracking-normalst flex items-center gap-2">
