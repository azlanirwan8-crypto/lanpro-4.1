export const styles = {
  ...
  inlineAddInput:
    "w-full bg-transparent border-none text-xs font-normal text-content-strong dark:text-content-inverse-strong placeholder:text-content-subtle focus:ring-0 outline-none",
};
