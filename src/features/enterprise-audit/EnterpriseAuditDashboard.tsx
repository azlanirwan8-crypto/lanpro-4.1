...
export const EnterpriseAuditDashboard: React.FC<EnterpriseAuditDashboardProps> = ({
  ...
  return (
    <div className="flex-1 flex flex-col min-h-0 bg-surface-muted p-2.5 sm:p-4 md:p-5 gap-3 sm:gap-4 text-left">
      {/* 1. Header — #407 PageHeader + Card */}
      <Card className="p-3 sm:p-4 md:p-5 shrink-0 shadow-2xs rounded-lg">
        <PageHeader
          breadcrumbs={[
          ...
          title={t("audit.title")}
          subtitle={<span className="hidden sm:inline">{t("audit.infraSubtitle")}</span>}
          actions={
