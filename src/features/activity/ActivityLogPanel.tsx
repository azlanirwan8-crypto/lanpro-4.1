        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 border-b border-border-subtle pb-6 mb-2">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="px-4 py-2.5 bg-indigo-600 border border-indigo-600 text-white rounded-xl text-xs font-medium shadow-soft-lg shadow-indigo-100 transition-all flex items-center gap-2 tracking-widest hover:bg-indigo-700 hover:-translate-y-0.5 active:scale-95 uppercase"
            >
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-8 py-5 min-w-[200px]">
                          <div className="flex items-center gap-3">
                            <div className="w-10 h-10 shrink-0 shadow-inner border-2 border-white rounded-full bg-surface-muted flex items-center justify-center relative ring-1 ring-border-subtle">
                              <UserAvatar
                                uid={log.userId}
