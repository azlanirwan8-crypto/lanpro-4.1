    ...
    <div className="space-y-4 relative">
      ...
      <div className="flex flex-wrap gap-2.5 items-center mt-4 pt-3 border-t border-border-faint">
        <button
          ...
          className="flex items-center gap-1.5 border border-emerald-200 bg-emerald-500/10 text-emerald-700 hover:bg-emerald-500/15 px-3 py-1.5 rounded-md text-xs font-medium transition mr-auto shadow-2xs cursor-pointer active:scale-95"
        >
          <FileEdit size={14} />
