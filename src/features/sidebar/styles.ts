export const styles = {
  ...
  sectionLabel: "text-[11px] font-medium text-[#878a99] uppercase tracking-wider",
  newButton:
    "p-2 min-w-9 min-h-9 justify-center text-xs text-[#abb9e8] hover:text-content-inverse hover:bg-white/10 rounded transition-all flex items-center gap-1",
  projectButton: "w-full flex items-center py-2.5 min-h-11 rounded-md transition-all text-sm",
  projectButtonSelected:
    "bg-[#364574] text-content-inverse font-medium shadow-sm border-l-3 border-amber-400",
  projectButtonDefault: "text-[#abb9e8] hover:bg-white/5 hover:text-content-inverse",
  indicator: "w-2 h-2 rounded-full shrink-0",
  demoWrapper: "px-2 py-4",
  demoButton:
    "w-full flex items-center justify-between gap-2 p-3 rounded-xl border border-blue-400/20 bg-white/5 text-blue-200 hover:bg-white/10 hover:text-content-inverse transition-all shadow-sm",
};
