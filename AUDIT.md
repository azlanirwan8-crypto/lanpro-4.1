...
| 135 | **Dwibahasa fase 2** — seluruh UI ikut tombol bahasa, kecuali data dari basis data. 410 string Inggris di 73 berkas, ditambah teks Indonesia yang juga harus dipindah ke kamus. Progres: Dashboard, Catatan Rapat, Tim, Manajemen Pengguna TUNTAS dan terverifikasi dua arah; Master Data dipindah tapi panelnya belum sempat dilihat di layar. Sisanya belum | **F12**                                                                                                         | 🟡  | Tinggi | Tidak | `BELUM` | §12 |
